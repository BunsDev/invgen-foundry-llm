...
library CurveMath {
    ...
    int128 public constant MAX = 0x4000000000000000;
    int128 public constant MAX_DIFF = -0x10C6F7A0B5EE;
    int128 public constant ONE_WEI = 0x12;

    function calculateFee(int128 _gLiq, int128[] memory _bals, Storage.Curve storage curve, int128[] memory _weights) public view returns (int128 psi_) {
        int128 _beta = curve.beta;
        int128 _delta = curve.delta;
        psi_ = calculateFee(_gLiq, _bals, _beta, _delta, _weights);
    }

    function calculateFee(int128 _gLiq, int128[] memory _bals, int128 _beta, int128 _delta, int128[] memory _weights) public pure returns (int128 psi_) {
    ...
    function calculateMicroFee(int128 _bal, int128 _ideal, int128 _beta, int128 _delta) public pure returns (int128 fee_) {
        if (_bal < _ideal) {
    ...
    function calculateTrade(Storage.Curve storage curve, int128 _oGLiq, int128 _nGLiq, int128[] memory _oBals, int128[] memory _nBals, int128 _inputAmt, uint256 _outputIndex) public view returns (int128 outputAmt_) {
    ...
    function calculateLiquidityMembrane(Storage.Curve storage curve, int128 _oGLiq, int128 _nGLiq, int128[] memory _oBals, int128[] memory _nBals) public view returns (int128 curves_) {
    ...
    function enforceSwapInvariant(int128 _oGLiq, int128 _omega, int128 _nGLiq, int128 _psi) public pure {
    ...
    function enforceLiquidityInvariant(int128 _totalShells, int128 _newShells, int128 _oGLiq, int128 _nGLiq, int128 _omega, int128 _psi) public pure {
    ...
    function enforceHalts(Storage.Curve storage curve, int128 _oGLiq, int128 _nGLiq, int128[] memory _oBals, int128[] memory _nBals, int128[] memory _weights) public view {
