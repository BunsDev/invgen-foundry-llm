...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
    ...
    function burn(address to) override external lock() returns (uint256 amount0, uint256 amount1) {
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves();
    ...
    function swap(uint256 amount0Out, uint256 amount1Out, address to, bytes calldata data) override external lock() {
