...
interface IcERC20 {
    ...
    function mint(address account, uint256 amount, string calldata txId) external returns (bool);
}
...
contract cERC20 is IcERC20 {
    ...
    constructor(string memory name, string memory symbol, uint8 decimals, address account, uint256 amount) {
        _name = name;
        _symbol = symbol;
        _decimals = decimals;
    ...
    function mint(address account, uint256 amount, string memory txId) public returns (bool) {
