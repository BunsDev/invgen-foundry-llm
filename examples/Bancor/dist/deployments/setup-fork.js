...
const { DEV_ADDRESSES, TENDERLY_PROJECT, TENDERLY_USERNAME, TENDERLY_FORK_ID: forkId, TENDERLY_NETWORK_NAME = 'mainnet' } = process.env;
...
const archiveArtifacts = async () => {
    ...
    const dest = path_1.default.resolve(path_1.default.join(__dirname, '..', 'forks', `fork-${forkId}.zip`));
...
const main = async () => {
    ...
    Logger_1.default.log(`   RPC: https://rpc.tenderly.co/fork/${forkId}`);
    Logger_1.default.log(`   Dashboard: https://dashboard.tenderly.co/${TENDERLY_USERNAME}/${TENDERLY_PROJECT}/fork/${forkId}`);
    Logger_1.default.log();
    Logger_1.default.log('********************************************************************************');
};
main()
...
//# sourceMappingURL=setup-fork.js.map